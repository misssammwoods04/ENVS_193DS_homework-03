...
p_data <- read.csv(here("Data", "PersonalData.csv"))
...
<img src="code/Sketch.jpg" alt = "Stress Map Sketch">
...
<img src="code/StressMaps.png" alt = "Stress Map Draft">

Affective Visualization Draft

<img src="code/StressScale.png" alt = "Stress Scale">
